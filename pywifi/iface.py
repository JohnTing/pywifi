...
class Interface:
    ...
    objects for linux)
    """
    _raw_obj:Dict[str, str] = {}
    _wifi_ctrl: wifiutil.WifiUtil = {}
    _logger = None
    ...
    def scan_results(self):
        ...
        bsses: List[Profile] = self._wifi_ctrl.scan_results(self._raw_obj)
    ...
    def connect(self, params: Profile):
